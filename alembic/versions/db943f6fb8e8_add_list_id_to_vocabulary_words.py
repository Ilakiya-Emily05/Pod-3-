...
down_revision: Union[str, Sequence[str], None] = '297ec505f124'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_vocabulary_words_list_id'), 'vocabulary_words', ['list_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_constraint('fk_vocabulary_words_list_id_vocabulary_lists', 'vocabulary_words', type_='foreignkey')
