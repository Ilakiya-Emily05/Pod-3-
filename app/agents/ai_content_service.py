...
class AIContentService:
    ...
    async def generate_words(self, industry: str, cefr_level: str, count: int = 10):
        words = await self.agent.generate(industry=industry, cefr_level=cefr_level, count=count)
